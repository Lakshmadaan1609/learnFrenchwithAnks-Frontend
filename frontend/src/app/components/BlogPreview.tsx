      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Stay updated with the latest tips, strategies, and insights to help you succeed in your French learning journey and Canada PR goals.
          </p>
        </div>
        ...
        <div className="text-center">
          <Link
            href="/blog"
            className="inline-flex items-center bg-primary text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition-colors"
          >
